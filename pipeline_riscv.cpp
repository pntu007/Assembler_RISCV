...
private:
    ...
    void detectHazard(){
        if(controlWord_s3 == "R" || controlWord_s4 == "B"){
        ...
        if(controlWord_s3 == "I" || controlWord_s4 == "L"){
    ...
    pipeline(string a){
        ...
        while(programCounter < inputFile.size() || stage1Active || stage2Active || stage3Active || stage4Active || stage5Active){
            // Execute stages in reverse order
                ...
                if(programCounter >= inputFile.size() && !stage2Active && !stage3Active && !stage4Active && !stage5Active){ break; }
            }
        }
...
void pipeline :: stage3() {
    ...
    if(controlWord_s3 == "R"){
        if(function3 == "000"){ // ADD operation
            ...
            arithmeticUnitOut_s4 = (myRegister[registerSource1_s3] < myRegister[registerSource2_s3]) ? 1 : 0;
            cout<<"SLT performed : "<<arithmeticUnitOut_s4<<endl;
        }
...
int main(){
    ...
    cout<<myRegister[3]<<endl;
    // cout<<myRegister[4]<<endl;
}